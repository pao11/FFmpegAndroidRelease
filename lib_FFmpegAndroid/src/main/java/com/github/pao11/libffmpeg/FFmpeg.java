...
public class FFmpeg implements FFmpegInterface {
    ...
    /**
     * 在Android Q及以上版本中，该方法已经不可用，因为系统限制了exc()方法访问APP的私有路径
     * 外面不需要再调用该方法。
     *
...
//            String outStr = context.getApplicationInfo().nativeLibraryDir + File.separator + "ffmpeg.so";
//            System.out.println(">>>>>>>>>>>>>>>>>>>4>" + outStr);
//            String[] ffmpegBinary = new String[] { outStr };
